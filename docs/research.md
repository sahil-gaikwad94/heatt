...
- **Microblogging essentials:** Short posts, replies, topic labels, follows, custom feed views, bookmarks, and community spaces are table stakes. Heatt adds a finite feed, visible “why this appeared” explanations, reaction intensity with one reaction per person, and deliberate stopping points.
